...
# Intensity (ECP and MSW) and track (LAT and LON) for the next 6 hours
output_lat_lon = Dense(12 * 2, activation='linear', name="output_lat_lon")(merged)  # 12 time steps, 2 units each
